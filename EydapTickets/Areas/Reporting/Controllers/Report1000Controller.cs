...
{
    public class Report1000Controller : BaseController
    {
        // GET: Report1000
        [HttpGet]
        ...
        protected void PrepareReport(Report1000 report, ReportCommonSearchModel model)
        {
            ...
            // replace the main query and fill the data source
